	...
	<div class="page full-h">
				...
				<div id="read-options-content" class="options-content">
					<div>
						...
						<button class="button is-light" onclick="toggleAskReadAgainModal(true)">
							...
							<span class="tooltip  mar-left-half is-tooltip-multiline is-tooltip-right" data-tooltip="The input file content was stored locally and used as data. Thus this view is independent of the source file">
								<i class="fas fa-question-circle"></i>
							</span>
						</button>
		...
		<div class="table-action-buttons">
			...
			<button class="button  is-outlined mar-left" onclick="postApplyContent(true)">
				...
				<span class="tooltip is-tooltip-multiline mar-left-half" data-tooltip="Applies the csv content back to the source file and saves the source file">
					<i class="fas fa-question-circle"></i>
				</span>
			</button>
	...
	<div id="help-modal" class="modal help-modal">
		...
		<div class="modal-content">
			<div class="box">
				...
				<div class="content">
					<ul>
						<li>If you edit an unnamed (csv) file and close it then the editor will be closed too (unsaved changes will be lost)!</li>
						...
						<li>Comments before and after csv content are preserved (if write comment option has a value)</li>
